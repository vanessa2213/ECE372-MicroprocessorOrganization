...
//SPI uses pins 50-53 on the microcontroller. See pin diagram sheet for exact details
#define DDR_SPI DDRB //Data direction Register for SPI
#define SPI_PORT PORTB // Port pin
#define DD_SS DDB0   //SS Chip select pin
#define DD_SCK DDB1  //SCK pin
#define DD_MOSI DDB2 //MOSI pin
